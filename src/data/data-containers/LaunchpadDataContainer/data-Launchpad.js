import {
    ...
    HomeDemo1FeaturesSC1,
    HomeDemo1FeaturesSC2,
    HomeDemo1FeaturesSC3,
...
export const SmartContractinfo = [
    {
        ...
        text1:" Rigorous due diligence ensures only top-tier projects make the cut.",
...
export const SmartContractOtherinfo = [
    {
        ...
        text:"Get the seed capital you need right when you need it.",
    },
    {
        img:HomeDemo1FeaturesS2,
        title:"Marketing & Exposure:",
        text:"Leverage our network for maximum visibility.",
    },
    {
        img:HomeDemo1FeaturesS3,
