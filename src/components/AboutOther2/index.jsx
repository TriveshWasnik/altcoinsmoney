          ...
          <div className="col-12 col-lg-6 offset-lg-0">
            <div className="who-we-contant">
              <div className="dream-dots text-left fadeInUp" data-aos="fade-up" data-aos-delay="200">
                <h2><span className={ClassTitle}>Our Mission</span></h2>
              </div>
              {/* <h4 className="fadeInUp" data-aos="fade-up" data-aos-delay="200">Our Mission</h4> */}
              <p className="fadeInUp" data-aos="fade-up" data-aos-delay="200">Our mission is to create an AI-enhanced decentralized ecosystem that acts as a catalyst for individuals, startups, and seasoned developers. Here, dreams meet reality.</p>
