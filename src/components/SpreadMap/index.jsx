        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 col-xs-12 mt-s">
            <div className="who-we-contant">
              ...
              <p className="text-white">The rapidly evolving world of cryptocurrencies can be overwhelming. Partner with AltCoinsMoney as your guide, and transform every twist and turn into an opportunity for innovation and collaboration.</p>
