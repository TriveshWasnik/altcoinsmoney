          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <p className="w-text fadeInUp" data-wow-delay="0.3s">Welcome to AltCoinsMoney, the platform that redefines the intersection of Artificial Intelligence and blockchain technology. In a world awash with decentralized finance options, we stand out as an innovator.</p>
