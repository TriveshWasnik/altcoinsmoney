          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <p className="w-text fadeInUp" data-wow-delay="0.3s">At AltCoinsMoney, we harness the dual powers of AI and blockchain to craft a platform that stands out in the crypto landscape.</p>
