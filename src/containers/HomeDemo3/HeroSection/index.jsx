          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <p className="w-text fadeInUp" data-wow-delay="0.3s">At Altcoins Money, we are not just crafting a dynamic financial ecosystem; we are also ensuring that joining our movement is as seamless as possible. Here is a simple guide to help you acquire Altcoins Money tokens using USDT.</p>
