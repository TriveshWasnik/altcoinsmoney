          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <h4>{text}</h4>
                <p className="w-text fadeInUp" data-wow-delay="0.3s">Enter a realm where efficiency is the name of the game. Experience the pinnacle of productivity with our AI Plugin Play Platform, a technology marvel that's bound to redefine how you work and create.</p>
